        ...
        <div className="mx-auto max-w-[640px] flex flex-col gap-6 py-10 px-4">
            <div className="flex items-center gap-3 px-3">
                ...
                <button type='submit'
                    ...
                    className='ml-auto bg-zinc-800 text-zinc-300 px-3 py-1.5 flex items-center rounded-lg font-medium text-sm transition-colors hover:bg-zinc-700'>
                    Compartilhar
            ...
            <form
                className='flex items-center gap-2 bg-zinc-900 p-2 rounded-xl borer border-zinc-800 ring-orange-400 ring-offset-2 ring-offset-zinc-950 focus-within:ring-1'>
                <input
                    type='text'
                    name='theme'
                ...
                />
                <button type='submit' className='bg-orange-400 text-orange-950 px-3 py-1.5 flex items-center rounded-lg font-medium text-sm transition-colors hover:bg-orange-500'>
                    Criar pergunta
